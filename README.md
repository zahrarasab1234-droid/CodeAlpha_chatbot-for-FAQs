...
* **Semantic Matching Engine:** Evaluates data vectors using **Cosine Similarity** algorithms with a strict confidence threshold matrix.
* **Frontend UI (`Streamlit`):** A custom-designed dark-mode console using responsive layout components and modern CSS injections.
